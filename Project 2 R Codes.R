...
rm(list = ls())
setwd("C:/Users/KINJAL/Desktop/EdWisor/Project 2")
# #loading Libraries
...
# mae        mse       rmse       mape 
# 3.1118527 14.2869939  3.7798140  0.4206355  
...
# mae       mse      rmse      mape 
# 1.7852323 5.5881669 2.3639304 0.2197498 
...
# mae       mse      rmse      mape 
# 1.7820706 5.3789197 2.3192498 0.2286021 
...
# mae       mse      rmse      mape 
# 1.5217003 4.4789144 2.1163446 0.1807939 
...
write.csv(xgb_pred,"xgb_predictions_R11.csv",row.names = FALSE)
